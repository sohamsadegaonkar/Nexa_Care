...
vi.mock('../../services/consentSigning', () => ({
  ...
  approveWithBiometric: vi.fn(),
  denyWithSignature: vi.fn(),
  isChallengeExpired: vi.fn(() => false),
}))
