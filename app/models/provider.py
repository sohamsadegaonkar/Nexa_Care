...
class ProviderTrustPermissionGrant(Base, UUIDPrimaryKeyMixin, TimestampMixin):
    ...
    __table_args__ = (
        CheckConstraint(
            "permission IN ('PROFESSIONAL_REVIEW', 'PRESCRIBING_ELIGIBILITY_REVIEW', 'MEDICATION_CATALOG_RELEASE_REVIEW', 'FACILITY_REVIEW', 'AFFILIATION_MANAGE', 'TRUST_PERMISSION_MANAGE')",
        ...
        CheckConstraint(
            "(permission IN ('PROFESSIONAL_REVIEW', 'PRESCRIBING_ELIGIBILITY_REVIEW', 'MEDICATION_CATALOG_RELEASE_REVIEW', 'TRUST_PERMISSION_MANAGE') AND scope_type = 'GLOBAL' AND facility_id IS NULL) OR (permission IN ('FACILITY_REVIEW', 'AFFILIATION_MANAGE') AND scope_type = 'FACILITY' AND facility_id IS NOT NULL)",
