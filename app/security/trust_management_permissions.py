...
class TrustManagementPermission(str, Enum):
    ...
    MEDICATION_CATALOG_RELEASE_REVIEW = "MEDICATION_CATALOG_RELEASE_REVIEW"
...
PERMISSION_SCOPES: dict[TrustManagementPermission, TrustPermissionScope] = {
    ...
    TrustManagementPermission.MEDICATION_CATALOG_RELEASE_REVIEW: TrustPermissionScope.GLOBAL,
