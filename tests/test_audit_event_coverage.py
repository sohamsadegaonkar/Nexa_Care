...
EXPECTED_EVENTS = {
    ...
    "PROVIDER_CONTACT_CHALLENGE_ISSUED",
    "PROVIDER_CONTACT_EMAIL_CHANGED",
    "PROVIDER_CONTACT_EMAIL_VERIFIED",
    "PROVIDER_CONTACT_PHONE_CHANGED",
    "PROVIDER_CONTACT_PHONE_VERIFIED",
    ...
    "DELEGATED_CLINICAL_TRUST_DENIED",
