...
EXPECTED_EVENTS = {
    ...
    "PATIENT_SESSION_REVOKED",
    "PATIENT_SESSIONS_REVOKED",
    ...
    "PATIENT_EXTERNAL_RECORD_CANDIDATE_REVIEWED",
    "PATIENT_EXTERNAL_RECORD_CANCELLED",
    "PATIENT_EXTERNAL_RECORD_SAVED",
    ...
    "PROVIDER_TRUST_PERMISSION_GRANTED",
    "PROVIDER_TRUST_PERMISSION_REVOKED",
    ...
    "MEDICATION_CATALOG_RELEASE_CREATED",
    "MEDICATION_CATALOG_ENTRY_REVIEWED",
    "MEDICATION_CATALOG_RELEASE_QUALIFIED",
    "MEDICATION_CATALOG_RELEASE_ACTIVATED",
    "MEDICATION_CATALOG_RELEASE_SUPERSEDED",
    "MEDICATION_CATALOG_RELEASE_REVOKED",
    "MEDICATION_CATALOG_EMERGENCY_DENY_RECORDED",
    "MEDICATION_CATALOG_EMERGENCY_DENY_CLEARED",
    "PROVIDER_RECHECK_GRACE_CANCELLED",
