...
4. **Mobile SDK**: Biometric signing in the frontend currently uses a `sig_v1_...` placeholder for the demo; the full native Secure Enclave integration requires Squad D's final mobile build.
