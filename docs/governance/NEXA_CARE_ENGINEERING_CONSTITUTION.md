...
Current head is `20260830_delegated_assurance`; changing it requires updating architecture contracts and validating ancestry, identifier length, and a single head.
