...
Current head is `20260919_medication_catalog`; changing it requires updating architecture contracts and validating ancestry, identifier length, and a single head.
