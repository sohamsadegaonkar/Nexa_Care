...
Repository baseline: `aa091e14cf38124ca81e32438b49bdad4d79be8b` on `main`; Alembic head `20260916_clinical_access_sessions`
...
Current head is `20260916_clinical_access_sessions`; changing it requires updating architecture contracts and validating ancestry, identifier length, and a single head.
