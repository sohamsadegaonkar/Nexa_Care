...
Repository baseline: `572eaec175df375d184f3cdaea5f913256e3094b` on `main`; Alembic head `20260918_treatment_vitals_encounter`
...
Current head is `20260918_treatment_vitals_encounter`; changing it requires updating architecture contracts and validating ancestry, identifier length, and a single head.
