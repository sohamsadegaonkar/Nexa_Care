...
Current head is `20260806_candidate_eligibility`; changing it requires updating architecture contracts and validating ancestry, identifier length, and a single head.
