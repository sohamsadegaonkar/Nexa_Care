...
Current head is `20260812_dek_store_runtime`; changing it requires updating architecture contracts and validating ancestry, identifier length, and a single head.
