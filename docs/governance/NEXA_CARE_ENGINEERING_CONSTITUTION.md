...
Current head is `20260801_textract_candidates`; changing it requires updating architecture contracts and validating ancestry, identifier length, and a single head.
