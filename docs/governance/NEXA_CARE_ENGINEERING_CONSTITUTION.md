...
Current head is `20260806_eligibility_reason`; changing it requires updating architecture contracts and validating ancestry, identifier length, and a single head.
