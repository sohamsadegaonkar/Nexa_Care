...
Repository baseline: `aa091e14cf38124ca81e32438b49bdad4d79be8b` on `main`; Alembic head `20260914_patient_search_identifiers`
...
Current head is `20260914_patient_search_identifiers`; changing it requires updating architecture contracts and validating ancestry, identifier length, and a single head.
